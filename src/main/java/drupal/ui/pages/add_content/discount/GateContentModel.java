...
import static drupal.ui.pages.add_content.discount.CreateDiscountPage.GATE_CONTENT_INPUT;
import static drupal.ui.pages.add_content.discount.CreateDiscountPage.GATE_CONTENT_SECTION;
import static drupal.ui.pages.add_content.discount.CreateDiscountPage.REGISTRATION_GATE_LIST;
...
public class GateContentModel extends MasterPage implements ISectionDataModel {
    ...
    public GateContentModel() {
        gateContent = "Test Gate";
    }
