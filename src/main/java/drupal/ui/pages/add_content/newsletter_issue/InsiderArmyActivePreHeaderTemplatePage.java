...
@Log4j2
public class InsiderArmyActivePreHeaderTemplatePage {

    private static final String URL_REGEX = "/newsletter-templates/preheader/insider-army-active";

    public InsiderArmyActivePreHeaderTemplatePage() {
