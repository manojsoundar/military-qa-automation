...
@Log4j2
public class TC249826_Edit_Brightcove_Video_Multiple_Categories_Breadcrumb_Category_Test extends AdminUITestBase {
    ...
    @Attributes(attributes = {@Attribute(key = "TestCaseId", value = "249826")})
    @TestCaseId("249826")
    public void editBrightcoveVideoAlternativeTextFieldWithNameContent() {
        ...
        logStep("Under the IMAGES section, type the content found in the 'Name' field to Alternative Text field");
        logStep("Press Save!");
        logStep("Verify Video updated!!");
        EditBrightcoveVideoPage editBrightcoveVideoPage = brightcoveResultPage.clickEditTab();
        String videoTitle = editBrightcoveVideoPage.getVideoTitle() + " Updated";
        editBrightcoveVideoPage.fillInTitle(videoTitle)
                               .clickSaveButton()
                               .validateUpdatedPage(videoTitle);
