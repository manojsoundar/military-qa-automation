...
public class TC249726_Create_Discount_Add_ConfirmPixels_Test extends AdminUITestBase {
    ...
    @Attributes(attributes = {@Attribute(key = "TestCaseId", value = "249726")})
    @TestCaseId("249726")
    public void createDiscount(List<ISectionDataModel> discountsData, List<ISectionDataModel> editDiscountData) {
        ...
        discountsPage.verifyCreatedDiscount(discountDataModel.getTitle())
                     ...
                     .clickEditTab()
                     .fillIn(editDiscountData)
                     .clickSaveButton()
                     .verifyEditedDiscount(editDiscountData.stream()
                                                           .filter(d -> d instanceof DiscountDataModel)
                                                           .map(c -> (DiscountDataModel) c)
                                                           .findFirst()
                                                           .get()
        ...
        return new Object[][]{
                {
                        ...
                        List.of(
                                DiscountDataModel.getEditDiscountData()
                        )
                }
        };
    }
